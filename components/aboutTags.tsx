...
export const PILLS: Pill[] = [
  ...
  { label: "Design systems", icon: Corner, x: 41, y: 23, rot: -15, bg: "#bfe36d" },
...
export const CHIPS: Chip[] = [
  { icon: Wand, x: 5, y: 45, rot: -6, bg: "#f7f7f5", size: 3.4, phone: { x: 88, y: 12, rot: -6 } },
  { icon: Cup, x: 29, y: 31, rot: 9, bg: "#d8c9fb", size: 3.2, phone: { x: 10, y: 34, rot: 9 } },
  { icon: Check, x: 26, y: 47, rot: -4, bg: "#a6d7f4", size: 3, phone: { x: 90, y: 48, rot: -4 } },
  { icon: Spark, x: 62, y: 82, rot: 6, bg: "#f7c32b", size: 3.3, phone: { x: 12, y: 68, rot: 6 } },
  { icon: Arrow, x: 2, y: 63, rot: 12, bg: "#fb8b3c", size: 3.9, phone: { x: 88, y: 82, rot: 12 } },
  { icon: Layers, x: 48, y: 40, rot: -8, bg: "#f7f7f5", size: 3.1 },
  { icon: Bolt, x: 82, y: 36, rot: 7, bg: "#f7c32b", size: 3.5 },
];
