...
/*
  ...
  solid index numeral. Clicking any work opens the shared ProjectModal,
  data-driven off the same PROJECTS array (no routes, no duplicated copy).
*/
