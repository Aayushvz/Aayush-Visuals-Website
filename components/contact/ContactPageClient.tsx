...
const SOCIALS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
        {/* Be: stem + two bowls, then the macron over a crossbarred e.
           Stroked at the same weight as its neighbours - the filled
           wordmark read far heavier than the rest of the row. */}
        <path d="M4 5.2V18.3" />
