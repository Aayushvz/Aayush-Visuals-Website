...
export function BehanceIcon({ className }: IconProps) {
  /* Be, drawn as letterforms rather than approximated: the B keeps its
     vertical stem and the e keeps its crossbar, which is what the old
     shape was missing. Inherits svgProps' 1.5 stroke like every other
     icon here. */
  return (
    <svg className={iconClass(className)} {...svgProps}>
      <path d="M4 5.2V18.3" />
      <path d="M4 5.2h5.1a3.15 3.15 0 0 1 0 6.3H4" />
      <path d="M4 11.5h5.9a3.4 3.4 0 0 1 0 6.8H4" />
      <path d="M14.1 8.2h5.6" />
      <path d="M13.5 15.3h6.6" />
      <path d="M20.1 15.3a3.3 3.3 0 1 0-1.1 2.5" />
    </svg>
  );
}
