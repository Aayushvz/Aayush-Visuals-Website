...
export function BehanceIcon({ className }: IconProps) {
  /* The one real brand logo in this file: the Behance Bē wordmark, macron
     and all. It is filled, so it overrides svgProps' fill/stroke - an
     outlined wordmark turns to mush at icon size, and an approximated one
     stops reading as Behance at all. */
  return (
